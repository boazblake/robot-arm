...
} from "./workspace-stabilization";
import type { StabilizationConfig, StabilizationState } from "./workspace-stabilization";
import type { WorkspacePosition } from "../mapping/workspace-mapping";
